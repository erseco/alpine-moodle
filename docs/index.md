...
- PHP 8.4 FPM with `ondemand` process manager — legacy Moodle tags retain PHP 8.3 ([runtime policy](php84.md))
...
- :material-language-php: **[PHP runtime policy](php84.md)** — PHP 8.4 for 5.3+, legacy tags retain PHP 8.3.
